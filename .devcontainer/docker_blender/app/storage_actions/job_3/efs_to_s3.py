...
def main():
    try:
        required_env_vars = ['BUCKET_NAME', 'BUCKET_KEY', 'EFS_BLENDER_FOLDER_PATH', 'AWS_ACCESS_KEY_ID', 'AWS_SECRET_ACCESS_KEY']
        ...
        thumbnail_output_path = os.path.join(efs_path, bucket_key)
